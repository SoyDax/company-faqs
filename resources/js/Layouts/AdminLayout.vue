...
<template>
    <div class="w-full h-full">
        <aside
            class="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-gray-400 transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
            <!-- SidebarLink  -->
            <div>
                ...
                <div class="text-3xl text-gray-200 font-bold text-center uppercase">
                ...
                <ul class="space-y-2 tracking-wide mt-8">
                    ...
                    <template v-if="hasRoles(['admin', 'moderador', 'escritor'])">
                        ...
                        <SidebarLink :href="route('categories.index')" :active="route().current('categories.index')">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#8d96a9" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <template v-if="hasRole('admin')">
                        <li>
                            <SidebarLink :href="route('users.index')" :active="route().current('users.index')">
                                ...
                                <span class="group-hover:text-gray-200 -mr-1 font-medium">Usuarios</span>
                            </SidebarLink>
                        </li>
                        ...
                        <li>
                            <SidebarLink :href="route('roles.index')" :active="route().current('roles.index')">
                                ...
                                <span class="group-hover:text-gray-200 -mr-1 font-medium">Roles</span>
                            </SidebarLink>
                        </li>
                        ...
                        <li>
                            <SidebarLink :href="route('permissions.index')"
                                ...
                                <span class="group-hover:text-gray-200 -mr-1 font-medium">Permisos</span>
                            </SidebarLink>
                        </li>
                    </template>
                </ul>
            ...
            <div class="px-6 -mx-6 pt-4 flex justify-between items-center border-t">
                <Link :href="route('logout')" method="post" as="button"
                    class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group hover:text-gray-100">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                </svg>
                <span class="group-hover:text-gray-200">Logout</span>
                </Link>
            </div>
        </aside>
            ...
            <div class="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5">
                <div class="px-6 flex items-center justify-between space-x-4 2xl:container">
                    <h5 hidden class="text-2xl text-gray-600 font-medium lg:block">
                        Sistema de gestión de conocimientos internos
                    </h5>
                    <!-- Hamburgesa de pestañas-->
                    <button @click="
                ...
                <div :class="{
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <template v-if="hasRoles(['admin', 'moderador', 'escritor'])">
                            <ResponsiveNavLink :href="route('departments.index')"
                                :active="route().current('departments.index')" class="flex space-x-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21" />
                        ...
                        <template v-if="hasRole('admin')">
                            ...
                            <ResponsiveNavLink :href="route('permissions.index')"
                                :active="route().current('permissions.index')" class="flex space-x-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M7.864 4.243A7.5 7.5 0 0 1 19.5 10.5c0 2.92-.556 5.709-1.568 8.268M5.742 6.364A7.465 7.465 0 0 0 4.5 10.5a7.464 7.464 0 0 1-1.15 3.993m1.989 3.559A11.209 11.209 0 0 0 8.25 10.5a3.75 3.75 0 1 1 7.5 0c0 .527-.021 1.049-.064 1.565M12 10.5a14.94 14.94 0 0 1-3.6 9.75m6.633-4.596a18.666 18.666 0 0 1-2.485 5.33" />
                    ...
                    <div class="mt-3 space-y-1">
                        <ResponsiveNavLink :href="route('logout')" method="post" as="button" class="flex space-x-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
