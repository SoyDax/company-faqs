...
const confirmDeleteSubcategories = (id) => {
  Swal.fire({
    title: "Eliminar SubCategoria",
    text: "¿Esta seguro que desea eliminar esta SubCategoria?",
    icon: "warning",
    ...
    if (result.isConfirmed) {
      form.delete(route("subcategories.destroy", id), {
        onSuccess: () => {
        ...
        onError: () => {
          Swal.fire(
            "Error",
            "Sucedio un error al eliminar la SubCategoria",
            "error"
          );
        },
      });
        ...
        <div class="w-full mb-3 overflow-hidden dark:bg-gray-700 rounded-lg">
          <div class="p-2 m-2">
            <div class="flex justify-between">
              ...
              <div class="flex">
                <select v-model="perPage" @change="getSubcategories"
            ...
            <TableRow v-for="(subcategory, i) in subcategories.data" :key="subcategory.id" class="border-b">
              ...
              <TableDataCell class="space-x-4">
                ...
                <button @click.prevent="
                  confirmDeleteSubcategories(subcategory.id)
