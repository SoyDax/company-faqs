...
<AdminLayout>
    <div class="max-w-7xl mx-auto py-4">
        <div class="flex justify-between">
            ...
            <Link :href="route('roles.index')" class="px-3 py-2 text-white font-semibold bg-gray-500 hover:bg-gray-600 rounded">
        ...
        <div class="mt-6 max-w-6xl mx-auto bg-slate-100 shadow-lg rounded-lg p-6">
            ...
            <form @submit.prevent="form.put(route('roles.update', role.id))">
                ...
                placeholder="Presiona para ver permisos"
                label="name"
                track-by="id"
                />
                </div>
                ...
                <template #default>
                    <TableRow v-for="rolePermission in role.permissions" :key="rolePermission.id" class="border-b">
                        ...
                        <TableDataCell class="space-x-4">
                            ...
                            <Link :href="route('roles.permissions.destroy', [role.id, rolePermission.id])" method="delete" as="button" class="px-3 py-2 text-white font-semibold bg-red-500 hover:bg-red-600 rounded">
