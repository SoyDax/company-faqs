...
<AdminLayout>
    <div class="max-w-7xl mx-auto py-4">
        <div class="flex justify-between">
            ...
            <Link :href="route('users.index')" class="px-3 py-2 text-white font-semibold bg-gray-500 hover:bg-gray-600 rounded">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 inline-block align-text-top mr-1">
        ...
        <div class="mt-6 max-w-6xl mx-auto bg-slate-100 shadow-lg rounded-lg p-6">
            ...
            <h1 class="text-2xl font-semibold text-indigo-700">EDITAR NUEVO USUARIO</h1>
    ...
    <div class="mt-6 max-w-6xl mx-auto bg-slate-100 shadow-lg rounded-lg p-6">
        <h1 class="text-2xl text-center font-semibold text-indigo-700">ROLES</h1>
        <div class="bg-slate-100">
            <Table>
                <template #header>
                    <TableRow>
                ...
                <template #default>
                    <TableRow v-for="userRole in user.roles" :key="userRole.id" class="border-b">
                        ...
                        <TableDataCell class="space-x-4">
                            ...
                            <Link :href="route('users.roles.destroy', [user.id, userRole.id])" method="DELETE" as="button" class="px-3 py-2 text-gray font-semibold bg-slate-200 hover:bg-slate-300 rounded" preserve-scroll>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" />
                            </svg>
    ...
    <div class="mt-6 max-w-6xl mx-auto bg-slate-100 shadow-lg rounded-lg p-6">
        <h1 class="text-2xl text-center font-semibold text-indigo-700">PERMISOS</h1>
        <div class="bg-slate-100">
            <Table>
                <template #header>
                    <TableRow>
                ...
                <template #default>
                    <TableRow v-for="userPermission in user.permissions" :key="userPermission.id" class="border-b">
                        ...
                        <TableDataCell class="space-x-4">
                            ...
                            <Link :href="route('users.permissions.destroy' , [user.id, userPermission.id, ])"  method="DELETE" as="button" class="px-3 py-2 text-gray font-semibold bg-slate-200 hover:bg-slate-300 rounded" preserve-scroll>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" />
                            </svg>
